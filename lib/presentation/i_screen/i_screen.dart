import '../i_screen/widgets/hortaemcasa_item_widget.dart';
...
import 'package:larissa_gabriele_s_application2/widgets/app_bar/appbar_searchview_1.dart';
...
class IScreen extends StatelessWidget {
        ...
        child: Scaffold(
            appBar: CustomAppBar(
                ...
                leading: AppbarImage(
                    ...
                    margin: EdgeInsets.only(left: 5.h, top: 15.v, bottom: 20.v),
                    onTap: () {
            ...
            body: SizedBox(
                ...
                child: Column(children: [
                  ...
                  Container(
                      ...
                      child: Text("msg_materias_inorg_nicos".tr,
                  ...
                  Expanded(
                      child: ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            return HortaemcasaItemWidget(onTapHortaemcasa: () {
                              onTapHortaemcasa(context);
                            });
                          })),
  ...
  /// Navigates to the pScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the [Navigator] widget
  /// to push the named route for the pScreen.
  onTapHortaemcasa(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.pScreen);
  }
