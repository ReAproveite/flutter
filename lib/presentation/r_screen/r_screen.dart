            ...
            body: SizedBox(
                ...
                child: Column(children: [
                  ...
                  Container(
                      ...
                      child: Text("msg_reciclagem_vasos".tr,
                          style: theme.textTheme.titleLarge)),
                  Container(
                      width: 360.h,
                      margin:
                          EdgeInsets.only(left: 17.h, top: 24.v, right: 13.h),
                      decoration: AppDecoration.outlinePrimary,
                      child: Text("msg_materiais_canos".tr,
                          maxLines: null,
                          overflow: TextOverflow.ellipsis,
                          style: theme.textTheme.bodyLarge)),
                  SizedBox(height: 62.v),
                  CustomImageView(
                      imagePath: ImageConstant.imgRectangle43194x259,
                      height: 194.v,
                      width: 259.h,
