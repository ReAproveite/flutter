...
class QScreen extends StatelessWidget {
  const QScreen({Key? key}) : super(key: key);
            ...
            body: SizedBox(
                ...
                child: Column(children: [
                  ...
                  Container(
                      ...
                      child: Text("msg_reciclagem_cesto".tr,
                          style: theme.textTheme.titleLarge)),
                  Container(
                      width: 360.h,
                      margin:
                          EdgeInsets.only(left: 19.h, top: 28.v, right: 11.h),
                      decoration: AppDecoration.outlinePrimary,
                      child: Text("msg_materiais_revistas".tr,
                          maxLines: null,
                          overflow: TextOverflow.ellipsis,
                          style: theme.textTheme.bodyLarge)),
                  SizedBox(height: 63.v),
                  CustomImageView(
                      imagePath: ImageConstant.imgRectangle468,
                      height: 194.v,
                      width: 259.h,
